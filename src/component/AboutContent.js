      ...
      >
        <div className={classes.aboutContent__wraper}>
          <div className={classes.aboutContent__wraper__text}>
            <p>
              After graduating from Informatics Engineering, Mariani then worked
              at{" "}
              <a
                href="https://gloding.com/en/"
                target="_blank"
                rel="noopener noreferrer nofollow"
              >
                PT Global Coding Indonesia
              </a>{" "}
            ...
            <p>
              ...
              page builders such as WordPress & Webflow. While improving her
              front-end skills, she also learns about designing digital
              interfaces and UX best practices that solve users’ problems.
            </p>
          </div>
